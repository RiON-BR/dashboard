            ...
            <div className="side-menu flex-lg-column me-lg-1">
                ...
                <div className="flex-lg-column my-auto">
                    <Nav className="side-menu-nav nav-pills justify-content-center" role="tablist">
                        ...
                        <NavItem id="Tasks">
                            <NavLink id="pills-tasks-tab" className={classnames({ active: activeTab === 'tasks' }) + " mb-2"} onClick={() => { toggleTab('tasks'); }}>
                                <i className="ri-checkbox-multiple-line"></i>
                            </NavLink>
                        </NavItem>
                        <UncontrolledTooltip target="Tasks" placement="top">
                            Tasks
                        </UncontrolledTooltip>
                        <NavItem id="Settings">
                            <NavLink id="pills-setting-tab" className={classnames({ active: activeTab === 'settings' }) + " mb-2"} onClick={() => { toggleTab('settings'); }}>
