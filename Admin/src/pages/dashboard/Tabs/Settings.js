...
import { Dropdown, DropdownMenu, DropdownItem, DropdownToggle, Card, Button, UncontrolledDropdown, Input, Label, Spinner } from "reactstrap";
    ...
    useEffect(() => {
        const fetchProfile = async () => {
          try {
            ...
            console.error("Failed to fetch profile in settings tab:", err);
          } finally {
            setLoading(false);
          }
        };
        ...
        <React.Fragment>
            <div>
                ...
                <div className="text-center border-bottom p-4">
                    ...
                    <h5 className="font-size-16 mb-1 text-truncate">{profile.FULLNAME || "User"}</h5>
                        ...
                        <Card className="accordion-item border mb-2">
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <h5 className="font-size-14">{profile.FULLNAME || "User"}</h5>
                                </div>
                                ...
                                <div className="mt-4">
                                    ...
                                    <h5 className="font-size-14">{profile.PHONE || "N/A"}</h5>
                                </div>

                                <div className="mt-4">
                                    <p className="text-muted mb-1">{t('Location')}</p>
                                    <h5 className="font-size-14 mb-0">{profile.ADDRESS || "N/A"}</h5>
                                </div>
                            </CustomCollapse>
